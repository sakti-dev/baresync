...
Before changing or verifying desktop, Android, Tauri, fixture app, fixture backend, or `tests/e2e` smoke automation, read `openspec/knowledge/E2E-TESTING-RUNBOOK.md`.
