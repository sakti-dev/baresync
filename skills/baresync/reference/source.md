...
Replace `<VERSION>` with the version from Step 2. Example: `npx opensrc path baresync@0.2.0`
...
Replace `<VERSION>` with the version from Step 2. Example: `git clone --branch v0.2.0 --depth 1 https://github.com/sakti-dev/baresync.git ./baresync-source`
