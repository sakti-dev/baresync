...
- "What permission id should a new Tauri command use?" → `crates/tauri-plugin-baresync/permissions/autogenerated/commands/` and `crates/tauri-plugin-baresync/permissions/default.toml` (command names use underscores; permission identifiers use hyphens)
...
| Permission identifier naming | `crates/tauri-plugin-baresync/permissions/autogenerated/commands/` and `crates/tauri-plugin-baresync/permissions/default.toml` |
