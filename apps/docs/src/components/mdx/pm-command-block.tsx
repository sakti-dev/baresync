...
const PM_ICONS: Record<Pm, React.ReactNode> = {
  bun: (
    <svg className="size-4" viewBox="0 0 128 128" fill="currentColor">
  ...
  pnpm: (
    <svg className="size-4" viewBox="0 0 128 128" fill="currentColor">
      <path fill="#f9ad00" d="M88 48H48v40h40V48zM48 88H8v40h40V88zM48 8V48h40V8H48z" />
      <path fill="#4e4e4e" d="M48 88h40v40H48V88zM88 88h40v40H88V88zM88 8h40v40H88V8z" />
    </svg>
  ),
  yarn: (
    <svg className="size-4" viewBox="0 0 128 128" fill="#2c8ebb">
...
export function PmCommandBlock({ className }: { className?: string }) {
  ...
  return (
    <div className={cn("overflow-hidden rounded-xl border border-fd-border bg-fd-background", className)}>
