...
If you want the copyable starter with both implementation styles side by side, use [`examples/inventory`](https://github.com/sakti-dev/baresync/tree/main/examples/inventory). It shows the primitive repository path and the Drizzle helper-backed path in the same app so you can compare the tradeoffs directly.
